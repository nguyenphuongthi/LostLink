    ...
    <div style={{ flex: '0 1 350px', minWidth: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ position: 'relative', height: 240, display: 'flex', alignItems: 'center', justifyContent: 'center', transform: 'scale(1.02)' }}>
        ...
        <div style={{ position: 'relative', width: 200, height: 200 }}>
          <div style={{ position: 'absolute', inset: 24, borderRadius: '50%', border: '1px solid rgba(110,168,255,.55)', animation: 'll-burst 2.6s cubic-bezier(.2,.7,.3,1) infinite' }} />
          <div style={{ position: 'absolute', inset: 24, borderRadius: '50%', border: '1px solid rgba(255,255,255,.28)', animation: 'll-burst 2.6s cubic-bezier(.2,.7,.3,1) infinite .16s' }} />
          <div style={{ position: 'absolute', inset: -14, animation: 'll-sweep 6s linear infinite' }}>
          ...
          <div style={{ position: 'absolute', left: 86, top: 85, width: 126, height: 2, transformOrigin: 'left center', '--a': '-22.3deg', background: 'linear-gradient(90deg, rgba(169,204,255,.9), rgba(169,204,255,0))', animation: 'll-tether 2.6s cubic-bezier(.16,.84,.28,1) infinite' }} />
          <div style={{ position: 'absolute', left: 86, top: 85, width: 108, height: 2, transformOrigin: 'left center', '--a': '160.5deg', background: 'linear-gradient(90deg, rgba(255,255,255,.7), rgba(255,255,255,0))', animation: 'll-tether 2.6s cubic-bezier(.16,.84,.28,1) infinite' }} />
          <div style={{ position: 'absolute', left: 70, top: 70, width: 32, height: 32, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,255,255,.95), rgba(169,204,255,0) 70%)', animation: 'll-snap 2.6s ease-out infinite' }} />
          <svg width="200" height="200" viewBox="0 0 200 200" fill="none" style={{ position: 'absolute', inset: 0, animation: 'll-lens-in 2.6s cubic-bezier(.16,.84,.28,1) infinite' }}>
            <defs>
            ...
            <circle cx="86" cy="86" r="62" stroke="url(#llLensG)" strokeWidth="11" strokeLinecap="round" strokeDasharray="292 390" transform="rotate(-52 86 86)" style={{ animation: 'll-trace 2.6s cubic-bezier(.16,.84,.28,1) infinite' }} />
            <path d="M131.5 131.5 L174 174" stroke="url(#llLensG)" strokeWidth="12" strokeLinecap="round" />
          </svg>
          <div style={{ position: 'absolute', left: 86, top: 86, animation: 'll-pin-in 2.6s cubic-bezier(.16,.84,.28,1) infinite' }}>
